<template>
    <div
        class="h-auto bg-white border border-gray-200 rounded-lg shadow cursor-pointer"
        @click.prevent="navigate('competition-detail', slug)"
    >
        <a>
        ...
        <div class="flex flex-col gap-1 px-5 pb-5">
            <button class="bg-[#4C4DDC] px-4 py-2 text-white text-xs rounded-md w-fit">Lihat Sertifikat</button>
            <button class="bg-[#4C4DDC] px-4 py-2 text-white text-xs rounded-md w-fit">Unduh Sertifikat</button>
        </div>        
    </div>
</template>
