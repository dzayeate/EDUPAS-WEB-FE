              ...
              <div class="flex w-full gap-6">
                <div class="w-1/2 flex flex-col gap-2 py-[12px]">
                  <div class="flex flex-col gap-2 mb-[8px]">
                    <label for="teamLeader">Ketua Tim</label>
                    <input
                      id="teamLeader"
                      type="text"
                  ...
                  <div class="flex mb-[8px]">
                    ...
                    <label
                      ...
                      benar dan dapat dipertanggung jawabkan</label
                    >
                  </div>
                  <div class="flex mb-[8px]">
                    <input
                    ...
                    <label
                      for="link-checkbox"
                      class="ms-2 text-[14px] font-normal text-[#404040] cursor-pointer"
                      >Saya setuju untuk mematuhi semua aturan dan regulasi yang
                      ditetapkan oleh penyelenggara kompetisi</label
                    >
                  </div>
                </div>
                <div class="w-1/2 flex flex-col gap-2 py-[12px]">
                  ...
                  <div class="flex flex-col gap-2 mb-[8px]">
                    <label for="teamLeader">Jumlah Anggota</label>
                    <input
                      id="teamLeader"
                      type="text"
                      placeholder="Nama Ketua Tim"
                  ...
                  <div
                    ...
                    :key="index"
                    :class="`${index !== 4 ?? 'mb-[8px]'} flex flex-col gap-2`"
                  >
                    <div class="flex items-center gap-4">
                      <label :for="'member' + index"
                        >Nama Anggota Tim - {{ index + 1 }}</label
                      >
                      <button
                        v-if="data.members.length > 1"
                        type="button"
                        @click="removeMemberHandler(index)"
                  ...
                  <div class="mb-[8px]">
                    ...
                    >
                      ...
                      <img
                        class="w-[20px] h-[20px]"
                        :src="require('@/assets/icons/icon-plus-circle.svg')"
                      />
                    </button>
                    <span class="font-normal text-[12px] text-[#616161]"
                      >Max 4 anggota*</span
                    >
                  </div>
                      ...
                      <div v-if="!files.length" class="flex flex-col">
                        <div class="w-full">
                          ...
                          <p class="text-xs text-gray-400 mt-1">
                            Maximum file size: 5Mb and Format file .pdf, .jpg,
                            jpeg, and .png
                          </p>
                        </div>
                      </div>
